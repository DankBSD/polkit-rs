...
bitflags! {
    ...
    pub struct AuthorityFeatures: u32 {
        ...
        const NONE = ffi::POLKIT_AUTHORITY_FEATURES_NONE as u32;
        ...
        const TEMPORARY_AUTHORIZATION = ffi::POLKIT_AUTHORITY_FEATURES_TEMPORARY_AUTHORIZATION as u32;
    }
}
...
bitflags! {
    ...
    pub struct CheckAuthorizationFlags: u32 {
        ...
        const NONE = ffi::POLKIT_CHECK_AUTHORIZATION_FLAGS_NONE as u32;
        ...
        const ALLOW_USER_INTERACTION = ffi::POLKIT_CHECK_AUTHORIZATION_FLAGS_ALLOW_USER_INTERACTION as u32;
    }
}
