...
use crate::AuthorityFeatures;
use crate::AuthorizationResult;
use crate::CheckAuthorizationFlags;
use crate::Details;
use crate::Identity;
use crate::Subject;
use crate::TemporaryAuthorization;
use glib::object::IsA;
...
glib::wrapper! {
    /// [`Authority`][crate::Authority] is used for checking whether a given subject is
...
impl Authority {
    ...
    >(
        ...
        >(
            ...
            let _ = ffi::polkit_authority_authentication_agent_response_finish(
    ...
    pub fn authentication_agent_response_future<P: IsA<Identity> + Clone + 'static>(
        &self,
        cookie: &str,
        identity: &P,
    ...
    /// authentication request identified by `cookie`. See [`authentication_agent_response()`][Self::authentication_agent_response()]
    /// for limitations on who is allowed is to call this method.
    ///
    /// The calling thread is blocked until a reply is received. See
    /// [`authentication_agent_response()`][Self::authentication_agent_response()] for the
    ...
    pub fn authentication_agent_response_sync<P: IsA<Identity>, Q: IsA<gio::Cancellable>>(
        &self,
        cookie: &str,
        identity: &P,
        cancellable: Option<&Q>,
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_authentication_agent_response_sync(
                self.to_glib_none().0,
                cookie.to_glib_none().0,
                identity.as_ref().to_glib_none().0,
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
    ...
    /// by `action_id`.
    ///
    /// Note that [`CheckAuthorizationFlags::ALLOW_USER_INTERACTION`][crate::CheckAuthorizationFlags::ALLOW_USER_INTERACTION]
    ...
    /// [`Error::Failed`][crate::Error::Failed] unless the process doing the check itsef is
    ...
    pub fn check_authorization<
        P: IsA<Subject>,
        Q: IsA<gio::Cancellable>,
        R: FnOnce(Result<AuthorizationResult, glib::Error>) + Send + 'static,
    >(
        &self,
        subject: &P,
        action_id: &str,
    ...
    pub fn check_authorization_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
        action_id: &str,
        details: Option<&Details>,
    ...
    /// [`CheckAuthorizationFlags::ALLOW_USER_INTERACTION`][crate::CheckAuthorizationFlags::ALLOW_USER_INTERACTION] flag. This
    ...
    /// # Returns
    ///
    /// A [`AuthorizationResult`][crate::AuthorizationResult] or [`None`] if `error` is set. Free with `g_object_unref()`.
    #[doc(alias = "polkit_authority_check_authorization_sync")]
    pub fn check_authorization_sync<P: IsA<Subject>, Q: IsA<gio::Cancellable>>(
        &self,
        subject: &P,
        action_id: &str,
        details: Option<&Details>,
    ...
    pub fn enumerate_actions<
        ...
        Q: FnOnce(Result<Vec<ActionDescription>, glib::Error>) + Send + 'static,
    >(
        &self,
    ...
    /// [`enumerate_actions()`][Self::enumerate_actions()] for the asynchronous version.
    /// ## `cancellable`
    /// A [`gio::Cancellable`][crate::gio::Cancellable] or [`None`].
    ///
    /// # Returns
    ///
    /// A list of
    /// [`ActionDescription`][crate::ActionDescription] or [`None`] if `error` is set. The returned list should
    /// be freed with `g_list_free()` after each element have been freed with
    /// `g_object_unref()`.
    #[doc(alias = "polkit_authority_enumerate_actions_sync")]
    pub fn enumerate_actions_sync<P: IsA<gio::Cancellable>>(
        &self,
        cancellable: Option<&P>,
    ...
    /// ## `subject`
    /// A [`Subject`][crate::Subject], typically a [`UnixSession`][crate::UnixSession].
    /// ## `cancellable`
    /// A [`gio::Cancellable`][crate::gio::Cancellable] or [`None`].
    /// ## `callback`
    /// A `GAsyncReadyCallback` to call when the request is satisfied.
    ...
    pub fn enumerate_temporary_authorizations<
        P: IsA<Subject>,
        Q: IsA<gio::Cancellable>,
        R: FnOnce(Result<Vec<TemporaryAuthorization>, glib::Error>) + Send + 'static,
    >(
        &self,
        subject: &P,
        cancellable: Option<&Q>,
    ...
    pub fn enumerate_temporary_authorizations_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
    ) -> Pin<
        Box_<
    ...
    ///
    /// The calling thread is blocked until a reply is received. See
    /// [`enumerate_temporary_authorizations()`][Self::enumerate_temporary_authorizations()] for the
    /// asynchronous version.
    /// ## `subject`
    /// A [`Subject`][crate::Subject], typically a [`UnixSession`][crate::UnixSession].
    /// ## `cancellable`
    ...
    ///
    /// A
    /// list of [`TemporaryAuthorization`][crate::TemporaryAuthorization] objects or [`None`] if `error` is set. The
    ...
    pub fn enumerate_temporary_authorizations_sync<P: IsA<Subject>, Q: IsA<gio::Cancellable>>(
        &self,
        subject: &P,
        cancellable: Option<&Q>,
    ...
    /// # Returns
    ///
    /// Flags from [`AuthorityFeatures`][crate::AuthorityFeatures].
    ...
    /// currently owns the name. You may connect to the `signal::glib::Object::notify`
    /// signal to track changes to the `property::Authority::owner` property.
    ///
    /// # Returns
    ///
    ...
    /// [`authentication_agent_response()`][Self::authentication_agent_response()].
    ///
    /// When the operation is finished, `callback` will be invoked in the
    /// <link linkend="g-main-context-push-thread-default">thread-default
    /// main loop`</link>` of the thread you are calling this method
    ...
    /// result of the operation.
    /// ## `subject`
    /// The subject the authentication agent is for, typically a [`UnixSession`][crate::UnixSession] object.
    /// ## `locale`
    ...
    >(
        ...
        >(
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_register_authentication_agent_finish(
                _source_object as *mut _,
                res,
                &mut error,
            );
    ...
    pub fn register_authentication_agent_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
        locale: &str,
        object_path: &str,
    ...
    /// [`register_authentication_agent()`][Self::register_authentication_agent()] for the
    /// asynchronous version.
    /// ## `subject`
    /// The subject the authentication agent is for, typically a [`UnixSession`][crate::UnixSession] object.
    /// ## `locale`
    ...
    pub fn register_authentication_agent_sync<P: IsA<Subject>, Q: IsA<gio::Cancellable>>(
        &self,
        subject: &P,
        locale: &str,
        object_path: &str,
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_register_authentication_agent_sync(
                self.to_glib_none().0,
                subject.as_ref().to_glib_none().0,
                locale.to_glib_none().0,
                object_path.to_glib_none().0,
    ...
    /// The object path for the authentication agent.
    /// ## `options`
    /// A [`glib::Variant`][crate::glib::Variant] with options or [`None`].
    /// ## `cancellable`
    /// A [`gio::Cancellable`][crate::gio::Cancellable] or [`None`].
    /// ## `callback`
    /// A `GAsyncReadyCallback` to call when the request is satisfied.
    ...
    >(
        ...
        >(
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_register_authentication_agent_with_options_finish(
                _source_object as *mut _,
                res,
                &mut error,
            );
    ...
    pub fn register_authentication_agent_with_options_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
        locale: &str,
        object_path: &str,
    ...
    /// The calling thread is blocked
    /// until a reply is received. See
    /// [`register_authentication_agent_with_options()`][Self::register_authentication_agent_with_options()] for the
    /// asynchronous version.
    /// ## `subject`
    /// The subject the authentication agent is for, typically a [`UnixSession`][crate::UnixSession] object.
    /// ## `locale`
    ...
    >(
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_register_authentication_agent_with_options_sync(
                self.to_glib_none().0,
                subject.as_ref().to_glib_none().0,
                locale.to_glib_none().0,
                object_path.to_glib_none().0,
    ...
    pub fn revoke_temporary_authorization_by_id<
        P: IsA<gio::Cancellable>,
    ...
    >(
        ...
        >(
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_revoke_temporary_authorization_by_id_finish(
                _source_object as *mut _,
                res,
                &mut error,
            );
    ...
    ///
    /// The calling thread is blocked until a reply is received. See
    /// [`revoke_temporary_authorization_by_id()`][Self::revoke_temporary_authorization_by_id()] for the
    /// asynchronous version.
    /// ## `id`
    /// The opaque identifier for the temporary authorization.
    /// ## `cancellable`
    ...
    pub fn revoke_temporary_authorization_by_id_sync<P: IsA<gio::Cancellable>>(
        &self,
        id: &str,
        cancellable: Option<&P>,
    ) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_revoke_temporary_authorization_by_id_sync(
                self.to_glib_none().0,
                id.to_glib_none().0,
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
                &mut error,
    ...
    /// the result of the operation.
    /// ## `subject`
    /// The subject to revoke authorizations from, typically a [`UnixSession`][crate::UnixSession].
    /// ## `cancellable`
    /// A [`gio::Cancellable`][crate::gio::Cancellable] or [`None`].
    /// ## `callback`
    /// A `GAsyncReadyCallback` to call when the request is satisfied.
    #[doc(alias = "polkit_authority_revoke_temporary_authorizations")]
    pub fn revoke_temporary_authorizations<
        P: IsA<Subject>,
        Q: IsA<gio::Cancellable>,
        R: FnOnce(Result<(), glib::Error>) + Send + 'static,
    >(
        ...
        >(
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_revoke_temporary_authorizations_finish(
                _source_object as *mut _,
                res,
                &mut error,
            );
    ...
    pub fn revoke_temporary_authorizations_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
    ) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>> {
        let subject = subject.clone();
    ...
    ///
    /// The calling thread is blocked until a reply is received. See
    /// [`revoke_temporary_authorizations()`][Self::revoke_temporary_authorizations()] for the
    /// asynchronous version.
    /// ## `subject`
    /// The subject to revoke authorizations from, typically a [`UnixSession`][crate::UnixSession].
    /// ## `cancellable`
    ...
    pub fn revoke_temporary_authorizations_sync<P: IsA<Subject>, Q: IsA<gio::Cancellable>>(
        &self,
        subject: &P,
        cancellable: Option<&Q>,
    ) -> Result<(), glib::Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_revoke_temporary_authorizations_sync(
                self.to_glib_none().0,
                subject.as_ref().to_glib_none().0,
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
                &mut error,
    ...
    >(
        ...
        >(
            ...
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_unregister_authentication_agent_finish(
                _source_object as *mut _,
                res,
                &mut error,
            );
    ...
    pub fn unregister_authentication_agent_future<P: IsA<Subject> + Clone + 'static>(
        &self,
        subject: &P,
        object_path: &str,
    ) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>> {
    ...
    /// until a reply is received. See
    /// [`unregister_authentication_agent()`][Self::unregister_authentication_agent()] for the
    /// asynchronous version.
    /// ## `subject`
    /// The subject the authentication agent is for, typically a [`UnixSession`][crate::UnixSession] object.
    /// ## `object_path`
    ...
    pub fn unregister_authentication_agent_sync<P: IsA<Subject>, Q: IsA<gio::Cancellable>>(
        &self,
        subject: &P,
        object_path: &str,
        cancellable: Option<&Q>,
        ...
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::polkit_authority_unregister_authentication_agent_sync(
                self.to_glib_none().0,
                subject.as_ref().to_glib_none().0,
                object_path.to_glib_none().0,
                cancellable.map(|p| p.as_ref()).to_glib_none().0,
    ...
    /// [`sync()`][Self::sync()] for the synchronous version.
    /// ## `cancellable`
    /// A [`gio::Cancellable`][crate::gio::Cancellable] or [`None`].
    /// ## `callback`
    /// A `GAsyncReadyCallback` to call when the request is satisfied.
    ...
    pub fn async_<
        P: IsA<gio::Cancellable>,
        Q: FnOnce(Result<Authority, glib::Error>) + Send + 'static,
    >(
        cancellable: Option<&P>,
        callback: Q,
    ) {
        ...
        let callback = async__trampoline::<Q>;
        unsafe {
    ...
    /// blocked until a reply is received. See [`async_()`][Self::async_()]
    ...
    /// # Returns
    ///
    /// A [`Authority`][crate::Authority]. Free it with
    /// `g_object_unref()` when done with it.
    #[doc(alias = "polkit_authority_get_sync")]
    #[doc(alias = "get_sync")]
    pub fn sync<P: IsA<gio::Cancellable>>(
        cancellable: Option<&P>,
    ...
    pub fn connect_backend_features_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::backend-features\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(
    ...
    pub fn connect_backend_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::backend-name\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(
    ...
    pub fn connect_backend_version_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"notify::backend-version\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(
